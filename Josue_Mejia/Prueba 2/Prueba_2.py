...
for url in url_guardadas:
    ...
    resultado = BeautifulSoup(response.content, "html.parser").find("meta", {"itemprop": "price"})  # Cambiado aquí
    precioActual = float(resultado['content']) if resultado else None  # Convertir el precio a float
